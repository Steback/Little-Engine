...
namespace lve  {
    ...
    GraphicsPipeline::GraphicsPipeline(VkDevice device, const std::string &vertName,
        ...
        LVE_VK_CHECK_RESULT(vkCreatePipelineLayout(device, &pipelineLayoutInfo, nullptr, &layout),
        ...
        LVE_VK_CHECK_RESULT(vkCreateGraphicsPipelines(device, VK_NULL_HANDLE, 1, &pipelineInfo, nullptr, &pipeline),
